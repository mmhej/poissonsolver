...
//----------------------------------------------------------------------------//
		...
		void setup2d( int [2], int [2], double [2], int = 0 );
		void setup3d( int [3], int [3], double [3], int = 0 );

		void set_return_grad( bool );
		void set_return_div( bool );
		void set_return_curl( bool );
		void set_reprojection( bool );
