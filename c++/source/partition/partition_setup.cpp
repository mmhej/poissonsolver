...
/*
	if(rank==0)
	{
		for (i = 0; i < nproc; ++i)
		{
			...
			std::cout << "ncell: " << part_all[i].ncell[0] << "  " << part_all[i].ncell[1] << "  " << part_all[i].ncell[2] << "  " << std::endl;
			std::cout << "icell: " << part_all[i].icell[0] << "  " << part_all[i].icell[1] << "  " << part_all[i].icell[2] << "  " << std::endl;
			std::cout << "dx:    " << part_all[i].dx[0] << "  " << part_all[i].dx[1] << "  " << part_all[i].dx[2] << "  " << std::endl;
			std::cout << "==" << std::endl;
		}
	}
*/
